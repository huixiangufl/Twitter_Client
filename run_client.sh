...
#sbt -J-Xmx"$memory" -J-Xms"$memory" "run 192.168.1.5:9056 1 12.5 50000 0 100000"
#sbt -J-Xmx"$memory" -J-Xms"$memory" "run 192.168.1.5:9056 1 12.5 50000 50000 100000"

#ip address and port
#192.168.1.5
#2322, 2222
#ssh -p 2322 huilingzhang@pcluster.cise.ufl.edu
#ssh -p 2222 huilingzhang@pcluster.cise.ufl.edu
